...
describe('FieldMapperDelegate', () => {
  ...
  it('should set lower permissions to null', tests.restrictAtOrAbove)
  it('should restrict all fields except the specified permission', tests._restrictTo)
  it('should set the cur permission lvl and restrict permission', tests.restrictTo)
  ...
  it('should set the cur permission lvl and restrict lower lvls', tests.atOrAbove)
